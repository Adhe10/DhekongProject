...
/////////////////
const BotName = 'Dhekong BOT☄'; 
const instagram = 'Nanti,belum bikin instagram'; 
const telegram = 'Ada,tapi belum mau di share'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'Masih Angan angan';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by Dhekong')
